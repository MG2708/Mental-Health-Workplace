...
#deafult values for param
defaultInt = 0
defaultString = 'NaN'
defaultFloat = 0.0

# Differentiate data parameters based on data type - string, int float
intFeatures = ['Age']
...
#fill the blanks with respective default values
for feature in df:
...
feature_cols = ['age_range','Gender', 'self_employed', 'family_history', 'work_interfere',
                 'no_employees', 'remote_work', 'tech_company', 'anonymity', 'leave', 'mental_health_consequence',
                 'phys_health_consequence', 'coworkers', 'supervisor', 'mental_health_interview', 'phys_health_interview',
                 'mental_vs_physical', 'obs_consequence', 'benefits', 'care_options', 'wellness_program',
                 'seek_help']
...
# Model 
classifier= RandomForestClassifier(n_estimators= 150, criterion="entropy", random_state=50)  
